      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="border-t-2 border-black pt-4 md:pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          ...
          <div className="flex gap-4 md:gap-6">
            ...
            <Link href="https://x.com/fosscuk" className="hover:scale-110 transition-transform">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </Link>
            <Link href="https://dub.sh/fosscu" className="hover:scale-110 transition-transform">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
