      ...
      <header>
        <div className="bg-header squiggle-bottom">
          <div className="container mx-auto px-4 py-8">
            <h1 className="text-4xl font-bold text-center mb-4 text-white font-serif">Our Team</h1>
            <div className="text-xl text-center mb-4 text-white">Meet the Amazing People Behind FOSSCU</div>
            <Navbar />
          </div>
        </div>
      </header>
            ...
            {teamData[1]["Volunteer"]?.map((member, index) => (
              ...
              >
                <div className="bg-white p-4 rounded-lg border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] 
                  hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 
                  hover:-translate-x-1 hover:-translate-y-1 text-center h-full flex flex-col">
                  <div className="relative w-24 h-24 mx-auto mb-3 rounded-full border-2 border-black overflow-hidden flex-shrink-0">
                    <Image
                      src={member.image}
                      alt={member.name}
                      fill
